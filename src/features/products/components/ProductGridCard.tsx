...
import { Edit, Trash2, MoreVertical, Package, Tag, Power, PowerOff } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Badge de Estado + Toggle Switch + Menú Opciones */}
        <div
        ...
        >
          ...
          {(onEdit || onDelete || onToggleStatus) && (
            <DropdownMenu>
              <DropdownMenuTrigger className="backdrop-blur-sm text-muted-foreground hover:text-foreground rounded-md cursor-pointer p-1">
                ...
                <>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span>{isActive ? t('common.deactivate', 'Desactivar') : t('common.activate', 'Activar')}</span>
                    </div>
                    <Switch
                      checked={isActive}
                      onCheckedChange={() => onToggleStatus(product.id)}
                      aria-label={isActive ? 'Desactivar producto' : 'Activar producto'}
                      className="data-[state=checked]:bg-emerald-600 scale-75 pointer-events-none"
                    />
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />
                </>
