...
interface UseRestockItemsColumnsProps {
  onEdit: (item: Restock) => void;
  onDelete: (id: string) => void;
  onComplete: (item: Restock) => void;
  onView: (item: Restock) => void;
}
...
export function useRestocksColumns({
  ...
  onEdit,
  onDelete,
}: UseRestockItemsColumnsProps): ColumnDef<any, Restock>[] {
